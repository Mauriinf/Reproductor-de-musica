...
<body>
    ...
    <div class="container">
		<div class="span10 offset1">
			<div class="row">
				<br><br>
    			<h3>Eliminar cancion</h3>
    		</div>

			<form class="form-horizontal" action="EliminarCanciones.php" method="post">
			  <input type="hidden" name="id" value="<?php echo $id;?>"/>
			  <p class="alert alert-error">Esta seguro de eliminar la cancion ?</p>
