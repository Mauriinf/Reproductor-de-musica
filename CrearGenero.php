  ...
  include 'includes/db_con.php';
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$stmt = $enlace->prepare("INSERT INTO genero (nombre,imagen) values(?,?)");
...
<body background="cabe.jpg">
    ...
    <div class="container">
    			...
    			<div class="span10 offset1">
	    			...
	    			<form class="form-horizontal" action="CrearGenero.php" method="post" enctype="multipart/form-data">
					  <div class="control-group <?php echo !empty($nombreError)?'error':'';?>">
					    <label class="control-label">Nombre de genero</label>
					    <div class="controls">
					      	<input name="nombre" type="text"  placeholder="Nombre del genero" value="<?php echo !empty($nombre)?$nombre:'';?>">
